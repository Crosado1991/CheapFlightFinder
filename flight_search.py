...
# Fetching environment variables securely
AMADEUS_API_KEY = os.getenv("ENV_AMA_API_KEY")
AMADEUS_SECRET = os.getenv("ENV_AMA_API_SECRET")

# Check if the environment variables are correctly loaded
if not AMADEUS_API_KEY or not AMADEUS_SECRET:
    raise EnvironmentError("Amadeus API key or secret is missing in environment variables.")
...
class FlightSearch:
    def __init__(self):
        ...
        # Fetching a new token upon initialization
    ...
    def get_destination_code(self, city_name):
        ...
        """
        print(f"Using token to get IATA code for {city_name}")
        ...
        # Sending the request to get city data
